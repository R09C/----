...
class TaskManagerGUI_Factory:
    ...
    def open_add_task_window(self):
        ...
        self.task_type_combobox.set(task_types[0])  # По умолчанию "Обычная"
    ...
    def add_task(self):
        ...
        try:
            if task_type == "С дедлайном":
                ...
                datetime.strptime(deadline_str, "%Y-%m-%d")  # Проверка формата даты
            ...
            task = self.task_factory.create_task(
                task_type, **specific_data
            )  # Используем Фабрику для создания задачи
